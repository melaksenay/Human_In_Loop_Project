...
# Initialize recommenders - will connect to Pinecone
...
#         try:
#             # Fetch the vector (include_metadata=True brings back the dict you stored)
#             resp = pinecone_index.fetch(
#                 ids=[str(idx)],
#                 include_metadata=True
#             )
#             meta = resp.get('vectors', {}).get(str(idx), {}).get('metadata', {})
#             name = meta.get('name') or f"{item_type.capitalize()} #{idx}"
#         except Exception as e:
